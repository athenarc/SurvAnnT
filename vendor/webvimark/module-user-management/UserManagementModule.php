...
class UserManagementModule extends \yii\base\Module
{
	 ...
	 * @var array
	 */
	public $rolesAfterRegistration = ['User'];
	...
	{
		return [
			['label' =>  UserManagementModule::t('back', 'Users') .' <i class="fas fa-users"></i> ', 'url' => ['/user-management/user/index']],
			['label' =>  UserManagementModule::t('back', 'Roles') .' <i class="fas fa-users"></i> ', 'url' => ['/user-management/role/index']],
			['label' =>  UserManagementModule::t('back', 'Permissions') .' <i class="fas fa-users"></i> ', 'url' => ['/user-management/permission/index']],
			['label' =>  UserManagementModule::t('back', 'Permission groups') .' <i class="fas fa-users"></i> ', 'url' => ['/user-management/auth-item-group/index']],
			['label' =>  UserManagementModule::t('back', 'Visit log') .' <i class="fas fa-users"></i> ', 'url' => ['/user-management/user-visit-log/index']],
		];
	}
