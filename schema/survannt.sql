...
INSERT INTO `auth_item` VALUES ('/*',3,NULL,NULL,NULL,1643795416,1643795416,NULL),
...
('/badges/badge-edit',3,NULL,NULL,NULL,1654420313,1654420313,NULL),
('/badges/badges-create',3,NULL,NULL,NULL,1654420313,1654420313,NULL),
('/badges/badges-delete-all',3,NULL,NULL,NULL,1654420313,1654420313,NULL),
('/badges/captcha',3,NULL,NULL,NULL,1654420313,1654420313,NULL),
('/badges/create',3,NULL,NULL,NULL,1644865983,1644865983,NULL),
('/badges/create-new-badges',3,NULL,NULL,NULL,1654420313,1654420313,NULL),
('/badges/delete',3,NULL,NULL,NULL,1644865983,1644865983,NULL),
('/badges/error',3,NULL,NULL,NULL,1654420313,1654420313,NULL),
...
('/questions/*',3,NULL,NULL,NULL,1654420312,1654420312,NULL),
('/questions/captcha',3,NULL,NULL,NULL,1654420313,1654420313,NULL),
('/questions/error',3,NULL,NULL,NULL,1654420313,1654420313,NULL),
('/questions/question-edit',3,NULL,NULL,NULL,1654420312,1654420312,NULL),
('/questions/questions-create',3,NULL,NULL,NULL,1654420312,1654420312,NULL),
('/questions/questions-delete-all',3,NULL,NULL,NULL,1654420312,1654420312,NULL),
('/questions/questions-use',3,NULL,NULL,NULL,1654420312,1654420312,NULL),
('/resources/*',3,NULL,NULL,NULL,1654420312,1654420312,NULL),
('/resources/captcha',3,NULL,NULL,NULL,1654420312,1654420312,NULL),
('/resources/collection-delete',3,NULL,NULL,NULL,1654420312,1654420312,NULL),
('/resources/error',3,NULL,NULL,NULL,1654420312,1654420312,NULL),
('/resources/resource-create',3,NULL,NULL,NULL,1654420312,1654420312,NULL),
('/resources/resource-edit',3,NULL,NULL,NULL,1654420312,1654420312,NULL),
('/resources/resources-delete-all',3,NULL,NULL,NULL,1654420312,1654420312,NULL),
('/resources/resources-import',3,NULL,NULL,NULL,1654420312,1654420312,NULL),
('/resources/resources-use',3,NULL,NULL,NULL,1654420312,1654420312,NULL),
...
('/site/badges-create-new',3,NULL,NULL,NULL,1654420312,1654420312,NULL),
...
('/site/survey-create-old',3,NULL,NULL,NULL,1654420312,1654420312,NULL),
...
('/site/surveys-statistics',3,NULL,NULL,NULL,NULL,NULL,NULL),
...
('/statistics/*',3,NULL,NULL,NULL,1654420311,1654420311,NULL),
('/statistics/campaign-statistics',3,NULL,NULL,NULL,1654420312,1654420312,NULL),
('/statistics/campaign-statistics-all',3,NULL,NULL,NULL,1654420311,1654420311,NULL),
('/statistics/captcha',3,NULL,NULL,NULL,1654420312,1654420312,NULL),
('/statistics/error',3,NULL,NULL,NULL,1654420312,1654420312,NULL),
...
('Admin','userGroup'),
('Admin','viewUsers'),
('adminPermissions','/badges/badge-edit'),
('adminPermissions','/badges/badges-create'),
('adminPermissions','/badges/badges-delete-all'),
('adminPermissions','/badges/captcha'),
('adminPermissions','/badges/create'),
('adminPermissions','/badges/create-new-badges'),
('adminPermissions','/badges/delete'),
('adminPermissions','/badges/error'),
('adminPermissions','/badges/index'),
('adminPermissions','/badges/update'),
('adminPermissions','/badges/view'),
('adminPermissions','/questions/captcha'),
('adminPermissions','/questions/error'),
('adminPermissions','/questions/question-edit'),
('adminPermissions','/questions/questions-create'),
('adminPermissions','/questions/questions-delete-all'),
('adminPermissions','/questions/questions-use'),
('adminPermissions','/resources/captcha'),
('adminPermissions','/resources/collection-delete'),
('adminPermissions','/resources/error'),
('adminPermissions','/resources/resource-create'),
('adminPermissions','/resources/resource-edit'),
('adminPermissions','/resources/resources-delete-all'),
('adminPermissions','/resources/resources-import'),
('adminPermissions','/resources/resources-use'),
...
('adminPermissions','/statistics/campaign-statistics'),
('adminPermissions','/statistics/campaign-statistics-all'),
('adminPermissions','/statistics/captcha'),
('adminPermissions','/statistics/error'),
...
CREATE TABLE `user` (
  ...
  `consent_leaderboard` tinyint(1) NOT NULL DEFAULT 0,
  `consent_details` tinyint(1) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
